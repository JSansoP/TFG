...
def create_all_dags(args, neural_factory):
    ...
    train_callback = nemo_pipeline.core.SimpleLossLoggerCallback(
    ...
    if args.checkpoint_dir or args.load_dir:
        chpt_callback = nemo_pipeline.core.CheckpointCallback(
            folder=args.checkpoint_dir, load_from_folder=args.load_dir, step_freq=args.eval_freq,
        )
        callbacks.append(chpt_callback)

    # Log training metrics to wandb
    wand_callback = nemo_pipeline.core.WandbCallback(train_tensors=[loss_t],
    ...
    for i, eval_dl in enumerate(data_layers_eval):
        ...
        eval_callback = nemo_pipeline.core.EvaluatorCallback(
...
def main():
    ...
    neural_factory = nemo_pipeline.core.NeuralModuleFactory(
        backend=nemo_pipeline.core.Backend.PyTorch,
    ...
    # train model
    lr_policy_class = getattr(nemo_pipeline.utils.lr_policies, args.lr_policy)
